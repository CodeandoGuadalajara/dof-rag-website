...
Hasta ahora esa evaluación solo se había corrido contra el subconjunto: las consultas buscaban entre los mismos 499 documentos del set. Esos números eran una cota optimista — encontrar un documento entre 499 es mucho más fácil que entre 657,867. Este post cuenta la primera medición a escala real, la del componente BM25, y todo lo que hubo que construir y corregir para obtenerla. El código del índice, los arneses de evaluación y los resultados reproducibles están publicados en el [PR #63 de `dof-rag`](https://github.com/CodeandoGuadalajara/dof-rag/pull/63), continuación del [PR #62](https://github.com/CodeandoGuadalajara/dof-rag/pull/62) que construyó el corpus completo.
